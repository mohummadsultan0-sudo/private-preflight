...
export default function Privacy() {
  return (
    <div className="site-shell privacy-shell">
      ...
      <footer className="site-footer"><div><BrandMark compact /><p>Private CSV Preflight · Browser-native inspection for CSV files.</p></div><div><Link href="/csv-formula-injection-scanner">Formula risk</Link><Link href="/csv-validator">Validator</Link><Link href="/csv-pii-checker">PII signals</Link></div><small>Signals, not guarantees.</small></footer>
    </div>
  );
}
