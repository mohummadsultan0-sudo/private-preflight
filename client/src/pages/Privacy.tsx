...
const boundaries = [
  { icon: FileKey2, title: "Selected CSV file", text: "The app reads the file through your browser’s local file APIs. The application does not send its contents or name to an analysis endpoint." },
  { icon: ScanLine, title: "Analysis results", text: "Rows, issue locations, and local reports are calculated in the active tab. They are not saved to an account, database, or application storage service." },
...
export default function Privacy() {
  return (
    <div className="site-shell privacy-shell">
      <header className="site-header"><div className="site-header__inner"><BrandMark /><a className="header-action" href="/#tool"><ArrowLeft aria-hidden="true" /> Return to preflight</a></div></header>
      <main className="privacy-main">
        <section className="privacy-hero"><div><span className="eyebrow"><span>PRIVACY / 01</span> Designed for a short data path</span><h1>Your file should not need a destination to be inspected.</h1><p>Private CSV Preflight is designed as a browser-only inspection tool. Its central product decision is that CSV analysis does not require a product API, account, or file store.</p></div><div className="privacy-seal"><img src="/manus-storage/private-csv-preflight-local-seal_34c78c7d.jpg" alt="" /><span>LOCAL ONLY</span><strong>Browser memory<br />during inspection</strong></div></section>
        ...
        <section className="privacy-detail"><div><span className="eyebrow"><span>LIFECYCLE / 02</span> What happens in this browser</span><h2>Choose, inspect, decide, clear.</h2></div><ol><li><span>01</span><p><strong>Choose a file.</strong> The browser gives the app a local File object only after you select it.</p></li><li><span>02</span><p><strong>Inspect locally.</strong> The app parses the text and derives results in the active page memory.</p></li><li><span>03</span><p><strong>Download only by choice.</strong> A report or changed copy is generated as a local browser download when you activate that action.</p></li><li><span>04</span><p><strong>Reset or refresh.</strong> The application clears its working state. It does not retain a file history.</p></li></ol></section>
      ...
      <footer className="site-footer"><div><BrandMark compact /><p>Private CSV Preflight · Browser-native inspection for CSV files.</p></div><div><a href="/csv-formula-injection-scanner">Formula risk</a><a href="/csv-validator">Validator</a><a href="/csv-pii-checker">PII signals</a></div><small>Signals, not guarantees.</small></footer>
    </div>
  );
}
