  ...
  return (
    <div className="site-shell privacy-shell">
      ...
      <main className="privacy-main">
        <section className="privacy-hero"><div><span className="eyebrow"><span>PRIVACY / 01</span> Designed for a short data path</span><h1>Your file should not need a destination to be inspected.</h1><p>Private Preflight is designed as a browser-only inspection suite. Its central product decision is that CSV and supported-image inspection do not require a product API, account, or file store.</p></div><div className="privacy-seal"><img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='60' fill='%23eee7da'/%3E%3Ccircle cx='60' cy='60' r='45' fill='none' stroke='%231f5a48' stroke-width='3'/%3E%3Cpath d='M35 54h50M35 66h38M35 78h24' stroke='%2324201d' stroke-width='5'/%3E%3C/svg%3E" alt="" /><span>LOCAL ONLY</span><strong>Browser memory<br />during inspection</strong></div></section>
