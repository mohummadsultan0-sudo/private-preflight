...
export default function ImageInspectorPage() {
  return <div className="site-shell image-shell"><header className="site-header"><div className="site-header__inner"><BrandMark /><nav aria-label="Primary navigation"><Link href="/">CSV preflight</Link><a href="#image-tool">Image inspector</a><Link href="/privacy">Privacy</Link></nav><Link href="/" className="header-action"><ArrowLeft aria-hidden="true" /> CSV preflight</Link></div></header><main><ImageInspector /></main><footer className="site-footer"><div><BrandMark compact /><p>Private Preflight · CSV preflight and image inspection, locally.</p></div><div><Link href="/">CSV preflight</Link><Link href="/privacy">Privacy</Link></div><small>Signals, not guarantees.</small></footer></div>;
}
